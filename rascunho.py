...
#Faça um programa que leia um nome do teclato e imprima quantas letras tem este nome
#nome = input()
#qnt = 0
#for a in nome:
#    qnt = qnt + 1 
#print(qnt)_________________________________________

#print(list(range(2,100,2)))________________________

#nome = 5
#for l in range(nome):
#    print(list(range(nome)))_______________________
...
#if a == "5":
#    print('Total: R$ {:.2f}'.format(1.50*float(b)))_________

# problema 1047 terminar
#leitura = input().split()
#hi, mi, hf, mf = leitura_____________________________
